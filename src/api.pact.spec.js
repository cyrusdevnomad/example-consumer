...
describe('API Pact test', () => {
  ...
  describe('retrieving a product', () => {
    test('ID 10 exists', async () => {
      // Arrange
      const expectedProduct = { id: '10', type: 'CREDIT_CARD', name: '28 Degrees', color: "red", pricexyz: "155"}
      //const expectedProduct = { id: '10', type: 'CREDIT_CARD', name: '28 Degrees'} 

      // Uncomment to see this fail
      // const expectedProduct = { id: '10', type: 'CREDIT_CARD', name: '28 Degrees', pricexyz: 30.0, newField: 22}
